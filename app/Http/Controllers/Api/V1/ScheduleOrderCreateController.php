   ...
   private function sendScheduledOrderNotification($order, $store)
    ...
    private function validateCartItems($cart_items, $store, $request)
    {
        ...
        foreach ($cart_items as $cart_item) {
            ...
            // Force empty array for variations - always send []
            $variation = [];
            // If variation price was provided, use it but still send empty array
            if (!empty($cart_item['variation']) && isset($cart_item['variation']['price'])) {
                $item_price = $cart_item['variation']['price'];
            }
