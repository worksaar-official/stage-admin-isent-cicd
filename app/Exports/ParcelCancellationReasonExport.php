...
class ParcelCancellationReasonExport implements  FromView, ShouldAutoSize, WithStyles ,WithHeadings, WithEvents
{
    ...
    {
        return view('file-exports.parcel-cancellation-reason', [
            'data' => $this->data,
        ]);
    }
