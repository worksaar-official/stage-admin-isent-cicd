            ...
            <div class="row g-2">
                            ...
                            <div class="row g-3 my-0">
                                <div class="col-md-12">
                                    <div class="position-relative">
                                        <label class="input-label"
                                            for="tax">{{ translate('Estimated Delivery Time ( Min & Maximum Time)') }}  <span class="text-danger">*</span></label>
                ...
                <div class="col-lg-12">
                    <div class="btn--container justify-content-end">
                        ...
                        <button type="submit" id="submitButton" class="btn btn--primary">{{ request()->pending == 1 ? translate('Update_&_Approve') : translate('messages.submit') }}</button>
                    </div>
                </div>
            </div>
        </form>
