...
<div class="invoice-body">
    <div class="invoice-space">
                    ...
                    <div class="text-left header-info-right header-info-inner">
                        ...
                        <table class="fs-10">
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="datas">{{ \App\CentralLogics\Helpers::format_currency($earnings->sum('amount')) }}</span>
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <table dir="{{ $site_direction }}" class="table w-100 main-table fs-10 text-clr">
            ...
            <tr>
                <td class="text-left">
                    <span>{{ \App\CentralLogics\Helpers::date_format($earning->created_at) }}</span>
                </td>
                ...
                <td class="text-right">
                    <span>{{ \App\CentralLogics\Helpers::format_currency($earning->amount) }}</span>
                </td>
